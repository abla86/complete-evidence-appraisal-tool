...
Functional repair/documentation commits are present; the repository history must be treated as the authoritative record of what was actually committed. No claim is made here that every historical change was authorised.
