...
`;
  ...
  public static createDefaultArticle(params: {
    ...
    return {
      id,
      // Import is deliberately instrument-neutral. Study design must be classified and
      // the appraisal instrument selected before any instrument-specific questions are attached.
      ...
      studyContext: params.studyContext || 'Ikke oppgitt – krever kontroll av originalkilden',
      design: params.design || 'Ukjent / uavklart – krever studiedesignklassifisering',
      dataCollection: 'Ikke oppgitt',
      participants: 'Ikke oppgitt',
      analyticMethod: 'Ikke oppgitt',
      reviewerName: undefined,
      reviewerRole: undefined,
      assessmentDate: undefined,
      projectName: 'Kunnskapsgrunnlag',
      summaryScore: undefined,
      overallVerdict: params.verdict,
      verdictNote: 'Importert for validering og studiedesignklassifisering før appraisal.',
