  ...
  public static getInitialWorkspace(articles: ArticleAppraisal[]): ResearchGroupWorkspace {
    ...
    articles.forEach((art, index) => {
      ...
      defaultConsensus[art.id] = {
        ...
        consensusStatus: art.overallVerdict === 'Inkluder' ? 'Ja' : art.overallVerdict === 'Ekskluder' ? 'Nei' : 'Uklart',
        rationale: 'Konsensus fastsatt etter uavhengig dobbeltgransking og strukturert gjennomgang.',
