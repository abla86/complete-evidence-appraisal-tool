          ...
          {selectedInstrumentId !== 'jbi-qualitative-2017' && activeTab === 'instrumentinfo' ? (
            ...
            <>
              ...
              {activeTab === 'reference_library' && (
                <ReferenceLibraryView articles={articles} />
              )}
        ...
        <footer className="bg-white border-t border-slate-200 py-6 sm:py-8 mt-12 print:hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            <div className="flex items-center gap-2">
              ...
              <span>Evidence Appraisal Tool • forskningsstøtte • metodisk integritet</span>
            </div>
            <div className="flex items-center gap-4 flex-wrap">
              <span className="inline-flex items-center gap-1"><ExternalLink className="w-3 h-3" /> Master application</span>
            </div>
          </div>
        </footer>
      </div>
